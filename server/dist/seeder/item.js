...
exports.websiteSeeds = exports.cronScheduleSeeds = exports.cronSchedules = void 0;
exports.cronJobSeed = cronJobSeed;
const config_1 = require("../config/config");
exports.cronSchedules = {
    everyHalfHour: "0,30 * * * * *",
    everyHour: "0 0 * * * *",
    every3Hours: "0 0 */3 * * *",
    every6Hours: "0 0 */6 * * *",
...
function cronJobSeed(cronScheduleId) {
    return {
        name: "Sending Telegram Notification",
        telegram_chat_id: config_1.config.telegram.chatId,
        cron_schedule_id: cronScheduleId,
    };
}
;
exports.cronScheduleSeeds = [
    {
        schedule: exports.cronSchedules.everyHalfHour,
        description: "Setiap setengah jam",
    },
    {
        schedule: exports.cronSchedules.everyHour,
        description: "Setiap 1 jam",
    },
    {
        schedule: exports.cronSchedules.every3Hours,
        description: "Setiap 3 jam",
    },
    {
        schedule: exports.cronSchedules.every6Hours,
        description: "Setiap 6 jam",
    },
    {
        schedule: exports.cronSchedules.every12Hours,
        description: "Setiap 12 jam",
    },
    {
        schedule: exports.cronSchedules.daily,
        description: "Setiap 1 hari pukul 00:00",
    },
];
exports.websiteSeeds = [
    {
        name: "Kuningankab",
